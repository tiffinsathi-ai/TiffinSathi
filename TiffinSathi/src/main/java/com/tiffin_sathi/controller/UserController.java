...
//    @PutMapping("/{userId}/change-password")
//    public ResponseEntity<?> changePassword(@PathVariable Long userId, @Valid @RequestBody ChangePasswordDTO changePasswordDTO) {
//        try {
//            User updatedUser = userService.changePassword(userId, changePasswordDTO.getNewPassword());
